  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-gray-950 dark:focus-visible:ring-blue-500 ",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-red-600 text-gray-50 hover:bg-red-700 dark:bg-red-700 dark:text-gray-50 dark:hover:bg-red-800",
        outline:
          "border border-gray-200 bg-background hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:border-gray-800 dark:hover:text-gray-50",
        outline_destructive:
        ...
        green:
          "bg-green-500 text-gray-50 hover:bg-green-500/90 dark:bg-green-700 dark:text-gray-50 dark:hover:bg-green-900/90",
      },
      size: {
